 ...
 *  (3) Wait for writes to flush on the chunk
 *  (4) Wait for maps from replicas
 *  (5) Compare / repair all scrub maps
 *
 ...
 * to wait until that update is applied before building a scrub map.
 *
